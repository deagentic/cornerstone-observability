#!/usr/bin/env python3
"""
cornerstone report — CLI for querying the Agentic CI observability service.

Install: pip install -e services/observability/
Usage:
    cornerstone report summary [--url URL] [--project SLUG] [--from DATE] [--to DATE] [--format table|json|csv]
    cornerstone report events  [--url URL] [--event-type TYPE] [--limit N] [--format table|json]
    cornerstone report cost    [--url URL] [--from DATE] [--to DATE] [--group-by project|model|skill]
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="cornerstone", description="Cornerstone CLI")
